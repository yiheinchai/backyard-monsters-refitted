...
export class SubscriptionControlPanelPopup extends subscriptions_controlPanel_popup {
    ...
    constructor() {
        super();
        this.setup();
        this.tDavesGold_title.htmlText = getKEYS().Get("dc_panel_golddave");
        ...
        if (DAVEStatueReward.doesStatueRewardExistsInInventory()) {
            ...
            this.bPlaceDave.Setup(getKEYS().Get("btn_placedave"));
            this.bPlaceDave.addEventListener(MouseEvent.CLICK, this.clickedPlaceDaveStatue.bind(this));
        } else {
            this.bPlaceDave.buttonMode = true;
            this.bPlaceDave.Setup(getKEYS().Get("btn_removedave"));
        ...
        this.bSave.Setup(getKEYS().Get("btn_save"));
        this.bSave.addEventListener(MouseEvent.CLICK, this.clickedSave.bind(this));
        this.bMembership.Setup(getKEYS().Get("btn_membership"));
        ...
        this.tMembers_title.htmlText = getKEYS().Get("dc_panel_benefits");
        this.tMembers_desc.htmlText = getKEYS().Get("dc_panel_benefitsdesc");
        this.tTerrainSelect.htmlText = getKEYS().Get("dc_panel_terrain");
    ...
    private clickedMembership(event: MouseEvent | null = null): void {
        ...
        getPOPUPS().Add(this._memberPopup);
    ...
    private clickedCloseMembership(event: Event): void {
        ...
        getPOPUPS().Remove(this._memberPopup!);
    }
