...
export class bubblepopup extends bubblepopup_CLIP {
    public _dropShadow: DropShadowFilter | null;
    ...
    public Setup(param1: number, param2: number, param3: string = ""): void {
    ...
    public Update(param1: string, param2: number = 1): void {
        let _loc5_: Rectangle | null = null;
        ...
        this.mcText.y = Math.floor(-14 - this.mcText.height);
        ...
        // Handling GLOBAL._ROOT access stubbing/safety
        let _loc3_: number = (GLOBAL._ROOT && GLOBAL._ROOT.stage) ? GLOBAL._ROOT.stage.stageWidth : 760;
        let _loc4_: number = GLOBAL.GetGameHeight();
