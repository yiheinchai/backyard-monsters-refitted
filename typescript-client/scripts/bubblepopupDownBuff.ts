...
export class bubblepopupDownBuff extends bubblepopupDownBuff_CLIP {
    ...
    public Resize(param1: number = 0): void {
        this.mcBG.height -= param1;
        this.mcBG.y += param1;
        if (param1 > 50) {
            param1 -= 5;
        }
        this.mcText.y += param1;
        this.mcTextDuration.y += param1;
    }
