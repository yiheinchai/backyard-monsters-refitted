 ...
 * Handles button states, highlighting, and text formatting
 * Converted from ActionScript to TypeScript
 */
export class ButtonBrown extends MovieClip {
    ...
    public _formatHighlight!: TextFormat;
    public _startY: number = 0;
    public _tab: boolean = false;
    public label: string = "";
    public labelKey: string = "";
    public _onColor: number = 3355443;
    public _offColor: number = 14398588;
    ...
    public Setup(param1: string = "", param2: boolean = false, param3: number = 0, param4: number = 0, param5: string = "#333333"): void {
        this._tab = param2;
        if (param3 > 0) {
            this.width = param3;
        }
