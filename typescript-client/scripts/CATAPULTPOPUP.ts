...
/**
 * CATAPULTPOPUP - Catapult Popup class
 * Handles the catapult siege weapon selection popup
...
export class CATAPULTPOPUP extends CATAPULTPOPUP_view {
    ...
    public Setup(param1: boolean): void {
        ...
        let _loc3_: number = 0;
        let _loc4_: string = "";
        let _loc5_: CATAPULTITEM | null = null;
        ...
        for (_loc4_ in ResourceBombs._bombs) {
            ...
            _loc5_.x = this._mc[_loc4_].x;
            _loc5_.y = this._mc[_loc4_].y;
            this._mc.removeChild(this._mc[_loc4_]);
            _loc5_.Setup(_loc4_);
    ...
    public Update(): void {
        let _loc4_: CATAPULTITEM | null = null;
        const _loc1_: any = {
    ...
    public Show(param1: MouseEvent | null = null): void {
        ...
        for (const item of UI2._top._creatureButtons) {
            _loc3_ = item;
