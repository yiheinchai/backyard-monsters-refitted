...
import { ListView_CLIP } from "./ListView_CLIP";
import { WMListViewItem } from "./WMListViewItem";

/**
 * ListView - paginated list view of bases in the map room.
 */
export class ListView extends ListView_CLIP {
    ...
    private sortHandler(event: MouseEvent): void {
        ...
        let sortFlags = isString ? 0 : 0; // NUMERIC handled by custom sort
