...
/**
 * Monster Madness popup info set 2 - second set of popup info.
 */
export class MonsterMadnessPopupInfoSet2 extends MonsterMadnessPopupInfo {
    constructor() {
        super();
    }
    ...
    public override getMedia(mode: number): DisplayObject {
        return this.setupImage("specialevent/monstermadness/pop_three_puttyface.png");
    }
