...
/**
 * SFSUserVariable - Implementation of UserVariable interface.
 */
export class SFSUserVariable implements UserVariable {
    ...
    public static fromSFSArray(arr: ISFSArray): UserVariable {
        return new SFSUserVariable(
            arr.getUtfString(0),
            arr.getElementAt(2),
            arr.getByte(1)
        );
