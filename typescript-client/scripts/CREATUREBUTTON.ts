...
/**
 * CREATUREBUTTON - Creature selection button for attack mode
 * Handles creature selection and bucket management during attacks
...
export class CREATUREBUTTON extends CREATUREBUTTON_CLIP {
    ...
    public Update(): void {
        let _loc1_: number = 0;
        _loc1_ = Number(ATTACK._curCreaturesAvailable[this._creatureID]);
        let _loc2_: string = "<b>";
