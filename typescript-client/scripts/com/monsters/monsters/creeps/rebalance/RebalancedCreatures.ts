...
import { Eyera } from "../Eyera";
import { Fang } from "../Fang";
import { Fink } from "../Fink";
import { Slimeattikus } from "../Slimeattikus";
import { Wormzer } from "../Wormzer";
import { Balthazar } from "../inferno/Balthazar";
import { KingWormzer } from "../inferno/KingWormzer";
import { Spurtz } from "../inferno/Spurtz";

// Import v2 variants (note: these may need to be defined or aliased appropriately)
// import { Pokeyv2 } from "../Pokeyv2";
// import { Octooozev2 } from "../Octooozev2";
// import { Boltv2 } from "../Boltv2";
// etc.

/**
 * RebalancedCreatures - Creature stat definitions for rebalanced gameplay.
 */
export class RebalancedCreatures {
    public static readonly REBALANCED_CREATURES: Record<string, any> = {
        "C1": {
            "index": 1,
            "page": 1,
            "order": 1,
