...
/**
 * frame2 - Popup window frame style 2
 * Handles scalable frame rendering with corners and fillers
...
export class frame2 extends MovieClip {
    ...
    public Clear(): void {
        if (this._bottomLeft && this._bottomLeft.bitmapData) {
            ...
            // this._bottomLeft.bitmapData = null; // readonly in some implementations, but ok in AS3
        }
